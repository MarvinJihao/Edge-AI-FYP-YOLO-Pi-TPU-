...
class yolov5_lite():
    ...
    def postprocess(self, frame, outs, pad_hw):
        ...
        for detection in outs:
            ...
            print(detection)
            scores, classId = detection[2], detection[3]
...
if __name__ == '__main__':
    ...
    parser.add_argument('--imgpath', type=str, default='./Badger18.jpg', help="image path")
    parser.add_argument('--modelpath', type=str, default='./best.onnx', help="onnx filepath")
    parser.add_argument('--classfile', type=str, default='./animal.names', help="classname filepath")
